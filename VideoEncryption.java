...
/*     */ 
/*     */ public class VideoEncryption extends JFrame {
...
/*  19 */     initComponents();
/*     */   } private JLabel jLabel4; private JLabel jLabel5; private JLabel jLabel6; private JTextField jTextField1; private JTextField jTextField2;
/*     */   int Encryptionkey() {
...
/* 120 */     this.jButton1.setText("Encrypt a video");
...
/* 124 */             VideoEncryption.this.jButton1ActionPerformed(evt);
/*     */           }
/*     */         });
/* 127 */     getContentPane().add(this.jButton1, new AbsoluteConstraints(50, 320, 241, 61));
/*     */     
/* 129 */     this.jButton2.setFont(new Font("Arial", 1, 18));
/* 130 */     this.jButton2.setForeground(new Color(255, 51, 0));
/* 131 */     this.jButton2.setText("Decrypt a Video");
...
/*     */           public void actionPerformed(ActionEvent evt) {
/* 135 */             VideoEncryption.this.jButton2ActionPerformed(evt);
/*     */           }
/*     */         });
/* 138 */     getContentPane().add(this.jButton2, new AbsoluteConstraints(550, 320, 241, 61));
/*     */     
...
/*     */           public void actionPerformed(ActionEvent evt) {
/* 146 */             VideoEncryption.this.jButton6ActionPerformed(evt);
/*     */           }
/*     */         });
/* 149 */     getContentPane().add(this.jButton6, new AbsoluteConstraints(10, 460, 50, -1));
/*     */     
...
/* 154 */     getContentPane().add(this.jLabel4, new AbsoluteConstraints(10, 180, 240, 30));
/* 155 */     getContentPane().add(this.jTextField2, new AbsoluteConstraints(250, 180, 140, 30));
/*     */     
/* 157 */     this.jLabel5.setFont(new Font("Arial", 1, 18));
/* 158 */     this.jLabel5.setForeground(new Color(255, 102, 51));
/* 159 */     this.jLabel5.setText("Enter the Decryption Key:");
/* 160 */     getContentPane().add(this.jLabel5, new AbsoluteConstraints(430, 180, 240, 30));
/* 161 */     getContentPane().add(this.jTextField1, new AbsoluteConstraints(680, 180, 140, 30));
/*     */     
/* 163 */     this.jLabel6.setIcon(new ImageIcon(getClass().getResource("/Images/zwaIWUh.jpg")));
/* 164 */     this.jLabel6.setText("jLabel5");
/* 165 */     getContentPane().add(this.jLabel6, new AbsoluteConstraints(0, 0, 840, 500));
/*     */     
/* 167 */     pack();
/*     */   }
/*     */   
...
/* 201 */       Logger.getLogger(VideoEncryption.class.getName()).log(Level.SEVERE, (String)null, ex);
/* 202 */     } catch (InstantiationException ex) {
/* 203 */       Logger.getLogger(VideoEncryption.class.getName()).log(Level.SEVERE, (String)null, ex);
/* 204 */     } catch (IllegalAccessException ex) {
/* 205 */       Logger.getLogger(VideoEncryption.class.getName()).log(Level.SEVERE, (String)null, ex);
/* 206 */     } catch (UnsupportedLookAndFeelException ex) {
/* 207 */       Logger.getLogger(VideoEncryption.class.getName()).log(Level.SEVERE, (String)null, ex);
/*     */     } 
/*     */ 
/*     */ 
/*     */     
...
/*     */           public void run() {
/* 214 */             (new VideoEncryption()).setVisible(true);
/*     */           }
/*     */         });
/*     */   }
/*     */ }
...
/* Location:              C:\Program Files (x86)\Logan File Security\Logan_File_Security.jar!\Markendize\com\VideoEncryption.class
